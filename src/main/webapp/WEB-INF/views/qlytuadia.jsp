...
<li><a href="tratre" style="height:110px;width:100px;"><img src="resources/images/tratre.png"/><b>TRẢ TRỄ</b></a></li>
<li><a href="datdia" style="height:110px;width:100px;"><img src="resources/images/datdia.png"/><b>ĐẶT ĐĨA</b></a></li>
<li><a href="#" style="height:110px;width:100px;"><img src="resources/images/thongke.png"/><b>BÁO CÁO</b></a>
<ul class="menucap2">
...
<h2 style="margin-left:40px;">DANH SÁCH TỰA ĐĨA CÓ SẴN </h2>
...
<th><button onclick="dds()"><img src="resources/images/them.png" />THÊM</button> </th>

</tr>
<c:forEach items="${tua }" var="tu">
<tr>
<td>${tu.maTieuDe }</td>
<td>${tu.tenTieuDe }</td>
<td>${tu.loaiDia }</td>
<td>${tu.mota }</td>
<td>${tu.thoiGianThue }</td>
<td>${tu.giaThue }</td>

<td><button id="buttonclick"  onclick="MoForm()"  data-ma="danhsachtuadia/${tu.maTieuDe }">
<img src="resources/images/sua.png"/>
DANH SÁCH TĐ</button>
<button><img src="resources/images/xoa.png"/><a href="xoatuadia/${tu.maTieuDe }">XÓA</a></button>
<td>
...
<div id="id01" class="modal">
  ...
  <form class="modal-content animate"  action="themtuadia" method="get">
    <div class="imgcontainer">
      <span onclick="document.getElementById('id01').style.display='none'" class="close" title="Close Modal">&times;</span>
      <h3>THÊM THÔNG TIN TỰA ĐĨA</h3>
    </div>

    <div class="container">
      <label for="txttd"><b>Tên tiều đề:</b></label>
      <input type="text" placeholder="Tên tiều đề" name="txttd" required>

      <label for="txtld"><b>Loại đĩa:</b></label>
      <input type="text" placeholder="Số chứng minh nhân dân" name="txtld" required>
	  <label for="txtgia"><b>Giá đĩa:</b></label>
   <input type="text" placeholder="Giá đĩa" name="txtgia" required>
	<label for="txttg"><b> Thời gian thuê:</b></label>
      <input type="text" placeholder="Thời gian thuê " name="txttg" required>
	  <label for="txtmt"><b> Mô tả:</b></label>
      <input type="text" placeholder="Mô tả " name="txtmt" required>
...
<div id="id02" class="modal1">
  ...
  <form class="modal-content animate" action="">
    <div class="imgcontainer">
      ...
      <h3>DANH SÁCH THÔNG TIN TỰA ĐĨA </h3>
    </div>
