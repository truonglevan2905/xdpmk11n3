...
<th>TÊN ĐĨA</th>
<th>TÌNH TRẠNG</th>
<th><button onclick="dds()"><img src="images/them.png" />THÊM</button> </th>
...
<td>sấ</td>
<td>xzxzzx</td>
<td><button   onclick="document.getElementById('id02').style.display='block'"><img src="images/sua.png"/>DANH SÁCH TĐ</button>
<button><img src="images/xoa.png"/>XÓA</button>
<td>
...
<div id="id01" class="modal">
  ...
  <form class="modal-content animate" action="/action_page.php">
    ...
    <div class="container">
	  ...
	  <label for="txtgia"><b>Gía đĩa:</b></label>
