...
<h2 style="margin-left:40px;">DANH SÁCH BĂNG ĐĨA</h2>
...
TÊN TỰA ĐĨA</th>
<th>TÌNH TRẠNG</th>
<th><button onclick="dds()"><img src="resources/images/them.png" /><a href="#">THÊM</a></button> </th>
...
<td >
<button><img src="resources/images/xoa.png"/><a href="xoabangdia/${l1.maDia}">XÓA</a></button>
<td>
...
<div id="id01" class="modal">
  ...
  <form class="modal-content animate" action="thembangdia" method="post">
    <div class="imgcontainer">
      <span onclick="document.getElementById('id01').style.display='none'" class="close" title="Close Modal">&times;</span>
      <h3>THÊM THÔNG TIN BĂNG ĐĨA</h3>
    </div>

    <div class="container">
    
    
      <label for="txttd"><b>Tên tựa đĩa:</b></label>
      <select name="txttd" style="width:355px;height:40px;">
      <c:forEach  items="${list }" var="l">
       <option>${l.tenTieuDe}</option>
      </c:forEach>
      </select><br/>
	  <label for="txttt"><b>Tình trạng:</b></label>
    <select name="txttt" style="width:355px;height:40px;">
	<option>Tốt</option>
