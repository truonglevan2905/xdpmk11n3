...
<td >
<button><img src="resources/images/xoa.png"/>XÓA</button>
<td>
...
<div id="id01" class="modal">
  ...
  <form class="modal-content animate" action="/action_page.php">
    ...
    <div class="container">
      <label for="txttenbd"><b>Tên băng đĩa:</b></label>
      <input type="text" placeholder="Tên băng đĩa" name="txttenbd" required>

      <label for="txttd"><b>Tên tựa đĩa:</b></label>
      <input type="text" placeholder="Tên đĩa đĩa" name="txttd" required>
	  <label for="txttt"><b>Tình trạng:</b></label><br/>
