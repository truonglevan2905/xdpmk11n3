...
<h2 style="margin-left:40px;">DANH SÁCH KHÁCH HÀNH</h2>
...
<th style="position:absolute;top:193px;"><button onclick="dds()"><img src="resources/images/them.png" /><a href="#">THÊM</a></button> </th>
...
<td>${d.address }</td>
<td>${d.phoneNum }</td>
<td><button   onclick="document.getElementById('id01').style.display='block'"><img src="resources/images/sua.png"/><a href="suakhachhang/${d.maKH}">SỬA</a></button>
<button><img src="resources/images/xoa.png"/><a href="xoakhachhang/${d.maKH}">XÓA</a></button>
<td>
...
<div id="id01" class="modal">
  ...
  <form class="modal-content animate" action="themkhachhang" method="post">
    ...
    <div class="container">
    <label for="txtdiachi"><b>Địa chỉ:</b></label>
      <input type="text" placeholder="Tên khách hàng" name="txtdiachi" required>
    
      <label for="txtname"><b>Tên khách hàng:</b></label>
      <input type="text" placeholder="Tên khách hàng" name="txtname" required>

    
	<label for="txtdienthoai"><b> Số điện thoại:</b></label>
...
<div id="id02" class="modal">
  ...
  <form:form class="modal-content animate" action="suakhachhang" modelAttribute="khachhang">
   <div class="imgcontainer">
    ...
    <div class="container">
     <label for="txtdiachi"><b>Mã Khách Hàng:</b></label>
